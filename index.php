        ...
        <div class="collapse navbar-collapse" id="collapsibleNavId">
            <ul class="navbar-nav mx-auto mt-2 mt-lg-0">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle"  href="#" role="button" id="dropdown-conference"  aria-haspopup="true" data-bs-toggle="dropdown" data-bs-toggle="hover" aria-expanded="false">Conference</a>
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle"  href="#" role="button" id="dropdown-committees"  aria-haspopup="true" data-bs-toggle="dropdown" data-bs-toggle="hover" aria-expanded="false">Committees</a>
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle"  href="#" role="button" id="dropdown-upcoming-events"  aria-haspopup="true" aria-expanded="false" data-bs-toggle="dropdown" data-bs-toggle="hover">Upcoming Events</a>
