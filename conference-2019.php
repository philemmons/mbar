...
echo '<link rel="canonical" href= "https://montereybayarearoundup.org/conference-2019.php" >';
            ...
            <ul class="navbar-nav mx-auto mt-2 mt-lg-0">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdown-conference">
                        ...
                        <a class="dropdown-item  active" aria-current="page" href="mbar_history.php">MBAR History<span class="visually-hidden">(2019 conference, click to go back)</span></a>
                ...
                <div class="col-xl-10 col-lg-10 col-md-12 py-4">
                    <div class="p-3 text-bg-light hero-text-border">
                        ...
                        <p>Frequent contact with newcomers and with each other is the bright spot of our lives.
                            ...
                            <a class="btn btn-link bb-link" href="pdf/BIG-BOOK-CHAPTER_7_P-89.pdf">Big Book p89<span class="sr-only">(Open pdf in browser)</span></button>
                        </p>
                        ...
                        <p>It is a fellowship in Alcoholics Anonymous. There you will find release from care, boredom and worry. Your imagination will be fired. Life will mean something at last. The most satisfactory years of your existence lie ahead. Thus, we find the fellowship, and so will you.
                            <br>
                            <img src="images/icons/pdf-logo.png" width="30" height="30" alt="Adobe PDF icon">
                            <a class="btn btn-link bb-link" href="pdf/BIG-BOOK-CHAPTER_11_P-152.pdf">Big Book p152<span class="sr-only">(Open pdf in browser)</span></button>
                        </p>
                    ...
                    <div class="p-3 text-bg-light hero-text-border">
                        <section aria-label="Friday's events">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <a href="con-2019-teresa.php" class="btn btn-outline-primary btn-sm">Read Transcript<span class="sr-only">(Opens a new window, click to go back)</span></a>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <a href="con-2019-harry.php" class="btn btn-outline-primary btn-sm">Read Transcript<span class="sr-only">(Opens a new window, click to go back)</span></a>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <a href="con-2019-jane.php" class="btn btn-outline-primary btn-sm">Read Transcript<span class="sr-only">(Opens a new window, click to go back)</span></a>
                                </div>
                            </div>
                    ...
                    <div class="p-3 text-bg-light hero-text-border">
                        <section aria-label="Saturday's events">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <a href="con-2019-doctors-opinion-panel.php" class="btn btn-outline-primary btn-sm">Read Transcript<span class="sr-only">(Opens a new window, click to go back)</span></a>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <a href="con-2019-emotional-sobriety-workshop.php" class="btn btn-outline-primary btn-sm">Read Transcript<span class="sr-only">(Opens a new window, click to go back)</span></a>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <a href="con-2019-many-paths-spirituality-panel.php" class="btn btn-outline-primary btn-sm">Read Transcript<span class="sr-only">(Opens a new window, click to go back)</span></a>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <a href="con-2019-charlie.php" class="btn btn-outline-primary btn-sm">Read Transcript<span class="sr-only">(Opens a new window, click to go back)</span></a>
                                </div>
                            </div>
                    ...
                    <div class="p-3 text-bg-light hero-text-border">
                        <section aria-label="Sunday's events">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <a href="con-2019-louise.php" class="btn btn-outline-primary btn-sm">Read Transcript<span class="sr-only">(Opens a new window, click to go back)</span></a>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <a href="con-2019-pat.php" class="btn btn-outline-primary btn-sm">Read Transcript<span class="sr-only">(Opens a new window, click to go back)</span></a>
                                </div>
                            </div>
