...
echo "<title>MBAR - Our Partner </title>";
echo '<link rel="canonical" href= "https://montereybayarearoundup.org/our_partner.php" >';
            ...
            <ul class="navbar-nav mx-auto mt-2 mt-lg-0">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdown-who-we-are">
                        <a class="dropdown-item active" href="our_partner.php" aria-current="page">Our Partner<span class="visually-hidden">(current)</span></a>
...
<main id="main-content">
        ...
        <div class="row justify-content-center py-6 mb-5 bg-body-tertiary bg-img-partner" title="Let It Begin With Me">
            <div class="col-xl-7 col-lg-7 col-md-12 py-5">
                <div class="p-3 text-center text-bg-light hero-text-border" title="Both function more effectively if we remains 'separate,' cooperating but not affiliating with the other.">
                    <h2 class="display-6 fw-bold px-3 px-md-0">Our Partner<br>Al-Anon Family Groups</h2>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row justify-content-center mb-5">
                <div class="col-xl-10 col-lg-10 col-md-12 py-4">
                    <div class="p-3 text-center text-bg-light hero-text-border">
                        <h4 class="fw-bold mb-3 text-primary text-center"><span class="text-dark px-3 px-md-0">Featured AA, Al-Anon, and Alateen Speakers</span></h4>
                        <hr>
                        <div class="mb-4">
    ...
    <!-- Part Three -->
    <article aria-label="Al_Anon Traditions">
