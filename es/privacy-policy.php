...
echo '<link rel="canonical" href= "https://montereybayarearoundup.org/es/privacy-policy.php" >';
                ...
                <div class="col-xl-10 col-lg-10 col-md-12 py-4">
                    <div class="p-3 text-bg-light hero-text-border" title="POLÍTICAS">
                        <section aria-label="USO Y POLÍTICAS">
                            ...
                            <br>
                            Si el USUARIO tiene dificultades para usar los boletos para ingresar al evento en el lugar, el USUARIO debe comunicarse con el SITIO de inmediato llamando al (866) 459-10233. Si el SITIO no puede resolver el asunto y el lugar le niega la entrada al USUARIO, el USUARIO puede ser elegible para un reembolso. Para ser elegible para un reembolso, el USUARIO debe obtener prueba escrita del lugar que demuestre que al USUARIO se le negó la entrada al evento y enviar esa prueba por correo electrónico junto con una descripción de las circunstancias al SITIO a customersupport@ticketfaster.com dentro de los diez (10) días posteriores a la evento.
                            <br>
            ...
            <div class="row justify-content-center mb-5">
                <div class="col-xl-8 col-lg-8 col-md-12 py-4">
                    <div class="p-3 text-center text-bg-light hero-text-border" title="¡Únete a nosotros en 2026!">
                        ...
                        <p class="text-dark">4 de Septiembre a las 8:00 p. m., hora del Pacífico
                            <br>
                            ¡Esta reunión está abierta a todos y lo alentamos a participar!
                        </p>
                        <p class="h3 text-dark">Reuniones en Persona</p>
                        <p class="text-dark">5 y 6 de Septiembre en el Centro de Conferencias de Monterey
                            <br>
