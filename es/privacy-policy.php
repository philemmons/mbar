...
echo "<br><title>MBAR - Política de Privacidad </title>";
echo '<br><link rel="canonical" href= "https://monterey.bayarearoundup.org/es/privacy-policy.php" />';
        ...
        <div class="row justify-content-center py-6 mb-5 bg-body-tertiary bg-img-privacy" title="Cyber Security theme with a lock and white gradient.">
            <div class="col-xl-7 col-lg-7 col-md-12 py-5">
                <div class="p-3 text-center text-bg-light hero-text-border" title="¡La preinscripción está abierta!">
                    <h2 class="display-6 fw-bold text-primary"><span class="text-dark px-3 px-md-0">Política de Privacidad y <br>
                            Condiciones de Servicio</span>
                    </h2>
                </div>
            </div>
        </div>
                ...
                <div class="col-xl-10 col-lg-10 col-md-12 py-4">
                    <div class="p-3 text-bg-light hero-text-border" title="POLÍTICAS">
                        <section aria-label="USO Y POLÍTICAS">
                            ...
                            <br><br>
                            <strong>ESTA POLÍTICA DE PRIVACIDAD DIVULGA LAS PRÁCTICAS DE PRIVACIDAD DE monterey.bayarearoundup.org. SE APLICA ÚNICAMENTE A LA INFORMACIÓN RECOGIDA POR ESTE SITIO WEB. ESTA POLÍTICA DE PRIVACIDAD NOTIFICARÁ AL USUARIO LO SIGUIENTE:</strong>
                            <br>
