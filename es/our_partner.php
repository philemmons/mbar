...
echo "<title>MBAR - Nuestro Compañero </title>";
echo '<link rel="canonical" href= "https://montereybayarearoundup.org/es/our_partner.php" >';
...
<main id="main-content">
        ...
        <div class="row justify-content-center py-6 mb-5 bg-body-tertiary bg-img-partner" title="Let It Begin With Me">
            <div class="col-xl-7 col-lg-7 col-md-12 py-5">
                <div class="p-3 text-center text-bg-light hero-text-border" title="Ambos funcionan más eficazmente si permanecemos 'separados', cooperando pero sin afiliarnos el uno al otro.">
                    <h2 class="display-6 fw-bold px-3 px-md-0">Nuestro Socio<br>Grupos Familiares de Al-Anon</h2>
                </div>
            </div>
        </div>
    </div>
    ...
    <!-- Part One -->
    <article aria-label="Compañero de Al-Anon">
        <div class="container shadow-wrap">
            <div class="row justify-content-center mb-5">
                <div class="col-xl-8 col-lg-8 col-md-10 py-4">
                    <div class="p-3  text-bg-light hero-text-border">
                        <section aria-label="Deuda de gratitud">
                            ...
                            <p>La siguiente resolución de agradecimiento a la Comunidad de los Grupos de Familia Al-Anon fue aprobada unánimemente por la Conferencia de Servicios Generales de Alcohólicos Anónimos de 1969.
                                ...
                                <br><br>
                                <span class="text-uppercase">Whereas</span>, es el deseo de esta Conferencia confirmar la relación entre Alcohólicos Anónimos y los Grupos de Familia Al-Anon, y
                                <br><br>
                                <span class="text-uppercase">Whereas</span>, es el deseo adicional de esta Conferencia reconocer la deuda de gratitud de A.A. con los Grupos de Familia Al-Anon, por lo tanto,
                                <br><br>
    ...
    <article aria-label="Tradiciones de Al-Anon">
        <div class="container mb-5 py-2 px-4">
            <div class="row">
                ...
                <div class="col-lg-8">
                    <section aria-label="Preámbulo de Al-Anon">
