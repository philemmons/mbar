                ...
                <div class="col-lg-4 mb-3 mb-lg-0 px-4">
                    <div class="card h-100 shadow-wrap">
                        <div class="card-body">
                            ...
                            <p class="card-text">Le recordamos amablemente: su registro no estará completo hasta que se haya realizado el <a href="register-now.php#payment-now">pago</a>.</p>
                        </div>
                        <div class="card-footer text-center">
