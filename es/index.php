    ...
    <section class="container shadow-wrap">
        <div class="row justify-content-center py-6 mb-5 bg-body-tertiary bg-img-home" role=img aria-label="Hermosa costa de la Bahía de Monterey con vista a Lover's Point.">
            <div class="col-xl-7 col-lg-7 col-md-12 py-5">
                <div class="p-3 text-center text-bg-light hero-text-border" title="¡La preinscripción está abierta!" aria-label="¡La preinscripción está abierta!">
                ...
                <div class="card h-100 shadow-wrap">
                    <div class="card-body">
                        <p class="card-title h6"><a href="upcoming_event.php">
                                <i class="bi bi-trophy me-2" style="font-size: 2rem; color: var(--color-8);"></i>Gracias a todos por acompañarnos en la Noche de Bingo en Moose Lodge.</a></p>
                ...
                <div class="card h-100 shadow-wrap">
                    <div class="card-body">
                        <p class="card-title h6"><a href="conference-2024.php">
                                <i class="bi bi-door-open me-2" style="font-size: 2rem; color: var(--color-8);"></i>Voluntarios</a></p>
        ...
        <div class="row justify-content-center mb-5">
            <div class="col-lg-4 mb-3 mb-lg-0 px-4">
                <div class="card h-100 shadow-wrap">
                    <div class="card-body">
                        <p class="card-title h6"><a href="conference-2024.php">
                                <i class="bi bi-mic me-2" style="font-size: 2rem; color: var(--color-8);"></i>Conferencia 2024</a></p>
                ...
                <div class="card h-100 shadow-wrap">
                    <div class="card-body">
                        <p class="card-title h6"><a href="registration.php">
                                <i class="bi bi-cart me-2" style="font-size: 2rem; color: var(--color-8);"></i>Registro</a></p>
                ...
                <div class="card h-100 shadow-wrap">
                    <div class="card-body">
                        <p class="card-title h6"><a href="activities.php">
                                <i class="bi bi-activity me-2" style="font-size: 2rem; color: var(--color-8);"></i>Actividades</a></p>
                ...
                <div class="card h-100 shadow-wrap">
                    <div class="card-body">
                        <p class="card-title h6"><a href="contact.php">
                                <i class="bi bi-people-fill me-2" style="font-size: 2rem; color: var(--color-8);"></i>Comité</a></p>
                ...
                <div class="card h-100 shadow-wrap">
                    <div class="card-body">
                        <p class="card-title h6"><a href="mbar_history.php">
                                <i class="bi bi-book me-2" style="font-size: 2rem; color: var(--color-8);"></i>Historia</a></p>
                ...
                <div class="card h-100 shadow-wrap">
                    <div class="card-body">
                        <p class="card-title h6"><a href="contribution.php">
                                <i class="bi bi-hand-thumbs-up me-2" style="font-size: 2rem; color: var(--color-8);"></i>Contribuciones</a></p>
