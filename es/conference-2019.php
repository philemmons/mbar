                ...
                <div class="col-xl-10 col-lg-10 col-md-12 py-4">
                    <div class="p-3 text-bg-light hero-text-border">
                        ...
                        <p>El contacto frecuente con los recién llegados y entre nosotros es el punto brillante de nuestras vidas.
                            ...
                            <button type="button" class="btn btn-link bb-link" class="bb-link" onclick="window.open('../pdf/BIG-BOOK-CHAPTER_7_P-89.pdf', 'Sage200Demo', 'width= 900, height= 768, status= 0, resizable= 0');return false;">Libro Grande p89</button><span class="sr-only">(Abre una nueva ventana)</span>
                        </p>
                        <p>Es una confraternidad de Alcohólicos Anónimos. Allí encontrará liberación del cuidado, el aburrimiento y la preocupación. Tu imaginación se disparará. La vida por fin significará algo. Los años más satisfactorios de tu existencia están por venir. Así, nosotros encontramos la comunión, y tú también la encontrarás.
                            ...
                            <button type="button" class="btn btn-link bb-link" onclick="window.open('../pdf/BIG-BOOK-CHAPTER_11_P-152.pdf', 'Sage200Demo', 'width= 900, height= 768, status= 0, resizable= 0');return false;">Libro Grande p152</button><span class="sr-only">(Abre una nueva ventana)</span>
                        </p>
                    </div>
                </div>
            </div>
                ...
                <div class="col-xl-10 col-lg-10 col-md-12 py-4">
                    <div class="p-3 text-center text-bg-light hero-text-border">
                        ...
                        <p>El contacto frecuente con los recién llegados y entre nosotros es el punto brillante de nuestras vidas.
                            <br>
                            <img src="../images/icons/pdf-logo.png" width="25" height="25" alt="Icono de Adobe PDF, sin enlace, solo diseño">
                            <button type="button" class="btn btn-link bb-link" onclick="window.open('../pdf/BIG-BOOK-CHAPTER_7_P-89.pdf', 'Sage200Demo', 'width= 900, height= 768, status= 0, resizable= 0');return false;">Libro Grande p89</button><span class="sr-only">(Abre una nueva ventana)</span>
                        </p>
