...
echo "<br><title>MBAR - 2019 Conferencia </title>";
echo '<br><link rel="canonical" href= "https://monterey.bayarearoundup.org/es/conference-2019.php" />';
...
<main id="main-content">
                ...
                <div class="col-xl-10 col-lg-10 col-md-12 py-4">
                    <div class="p-3 text-bg-light hero-text-border">
                        <section aria-label="Eventos del Viernes">
                            <h3 class="text-center"><i class="bi bi-calendar2-check-fill" aria-hidden="true"> </i>Viernes, 30 de Agosto de 2019</h3>
                            <br>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <a href="../audio-transcript/2019/Teresa-J-2019.txt" class="btn btn-outline-primary btn-sm">Leer Transcripción<span class="sr-only">(Abre una nueva ventana, haz clic para regresar)</span></a>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <a href="../audio-transcript/2019/Harry-H-2019.txt" class="btn btn-outline-primary btn-sm">Leer Transcripción<span class="sr-only">(Abre una nueva ventana, haz clic para regresar)</span></a>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <a href="../audio-transcript/2019/Al-Anon-Jane-H-2019.txt" class="btn btn-outline-primary btn-sm">Leer Transcripción<span class="sr-only">(Abre una nueva ventana, haz clic para regresar)</span></a>
                                </div>
                            </div>
                ...
                <div class="col-xl-10 col-lg-10 col-md-12 py-4">
                    <div class="p-3 text-bg-light hero-text-border">
                        <section aria-label="Eventos del Sabado">
                            <h3 class="text-center"><i class="bi bi-calendar2-check-fill" aria-hidden="true"> </i>Sábado, 31 de Agosto de 2019</h3>
                            <span class="text-uppercase">Steinbeck Ballroom</span> 2 y 3 (Subiendo las escaleras mecánicas)
                            <br><br>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <a href="../audio-transcript/2019/Doctors-Opinion-Panel-Dr-Sheila-C-and-Dr-Jerry-C-2019.txt" class="btn btn-outline-primary btn-sm">Leer Transcripción<span class="sr-only">(Abre una nueva ventana, haz clic para regresar)</span></a>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <a href="../audio-transcript/2019/Emotional-Sobriety-Workshop-Sonny-C-and-Masa-M-2019.txt" class="btn btn-outline-primary btn-sm">Leer Transcripción<span class="sr-only">(Abre una nueva ventana, haz clic para regresar)</span></a>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <a href="../audio-transcript/2019/The-Many-Paths-to-Spirituality-Panel-Jean-T-and-Cari-H-2019.txt" class="btn btn-outline-primary btn-sm">Leer Transcripción<span class="sr-only">(Abre una nueva ventana, haz clic para regresar)</span></a>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <a href="../audio-transcript/2019/Charlie-H-2019.txt" class="btn btn-outline-primary btn-sm">Leer Transcripción<span class="sr-only">(Abre una nueva ventana, haz clic para regresar)</span></a>
                                </div>
                            </div>
    ...
    <!-- Part Four -->
    <article aria-label="Horario domingo MBAR 2019">
        <div class="container shadow-wrap">
            <div class="row justify-content-center mb-5">
                <div class="col-xl-10 col-lg-10 col-md-12 py-4">
                    <div class="p-3 text-bg-light hero-text-border">
                        <section aria-label="Eventos del Domingo">
                            <h3 class="text-center"><i class="bi bi-calendar2-check-fill" aria-hidden="true"> </i>Domingo, 1 de Septiembre de 2019</h3>
                            <span class="text-uppercase">Steinbeck Ballroom</span> 2 y 3
                            <br><br>
                            <p><strong>8:00am - <span class="text-uppercase">A.A. Calendario de Reuniones de Maratón</span></strong>
                                <br>
                                8:00am Chuck N. (Salinas)
                                <br><br>
                                <strong>8:00am - <span class="text-uppercase">Calendario de Reuniones del Maratón de Al-Anon</span></strong>
                                <br>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <a href="../audio-transcript/2019/Al-Anon-Louise-M-2019.txt" class="btn btn-outline-primary btn-sm">Leer Transcripción<span class="sr-only">(Abre una nueva ventana, haz clic para regresar)</span></a>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <a href="../audio-transcript/2019/Pat-B-2019.txt" class="btn btn-outline-primary btn-sm">Leer Transcripción<span class="sr-only">(Abre una nueva ventana, haz clic para regresar)</span></a>
                                </div>
                            </div>
    ...
    <!-- Part Six -->
    <div id="map"></div>
    <article aria-label="Mapa de Google del MBAR 2019">
        <div class="container shadow-wrap">
            <div class="row justify-content-center mb-5">
                <div class="col-xl-10 col-lg-10 col-md-12 py-4">
                    <div class="p-3 text-center text-bg-light hero-text-border">
                ...
                <div class="col-xl-10 col-lg-10 col-md-12 py-4">
                    <div class="p-3 text-bg-light hero-text-border">
                        <section aria-label="Unidad de Eventos">
                            ...
                            <p><strong><span class="text-uppercase">Accesibilidad ADA</span>: MBAR 2019 proporcionará dos intérpretes de ASL en estos días:</strong>
                            </p>
                            <ul>
