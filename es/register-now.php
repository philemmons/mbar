                ...
                <div class="col-xl-10 col-lg-10 col-md-12 py-4">
                    <div class="p-3 text-center text-bg-light hero-text-border">
                        <section aria-label="Descargar formulario pdf">
                            ...
                            <p><a class="btn btn-primary btn-sm" href="../pdf/mbar-register-form-en.pdf"><img src="../images/icons/pdf-logo.png" width="30" height="30" alt="Adobe PDF icon">Formulario de inscripción de MBAR 2024<span class="sr-only">(Abrir PDF en el navegador)</span></a>
                            </p>
