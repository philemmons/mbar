...
echo '<link rel="canonical" href= "https://monterey.bayarearoundup.org/mbar_history.php" />';
                ...
                <div class="col-sm-5  text-center px-5">
                    <section aria-label="Display past logos with carousel">
                        ...
                        <div id="carouselExampleFade" class="carousel slide carousel-fade">
                            ...
                            <button class="btn btn-primary btn-sm" type="button" data-bs-target="#carouselExampleFade" data-bs-slide="prev">
                                <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                                <span class="visually-hidden">Previous</span>
                            </button>

                            <button class="btn btn-primary btn-sm" type="button" data-bs-target="#carouselExampleFade" data-bs-slide="next">
                    ...
                    <div class="card h-100 shadow-wrap">
                        <div class="card-body">
                            <section aria-label="2019 and 2022 Schedules">
                                ...
                                <p class="card-text"> <a href="https://monterey.bayarearoundup.org/conference-2022.php" class="bb-link" target="_blank">2022 Conference<span class="sr-only">(Opens a new window)</span></a></p>
                                <p class="card-text"> <a href="https://monterey.bayarearoundup.org/conference-2019.php" class="bb-link" target="_blank">2019 Conference<span class="sr-only">(Opens a new window)</span></a></p>
                            </section>
                        </div>
                        ...
                        <div class="card-body">
                            <section aria-label="2017 Speaker">
                                ...
                                <div class="d-grid gap-2 pt-3">
                                    <a href="../audio-transcript/2017/Paul-O-2017.txt" class="btn btn-outline-primary btn-sm">Read Transcript<span class="sr-only">(Opens a new window, click to go back)</span></a>
                                </div>
                            </section>
                        </div>
                        <div class="card-footer text-center">
                    ...
                    <div class="card h-100 shadow-wrap">
                        <div class="card-body">
                            <section aria-label="Past Fliers">
                                ...
                                <p class="d-grid gap-2">
                                    <button type="button" class="btn btn-outline-primary btn-sm" onclick="window.open('pdf/MBAR-2014-Program.pdf', 'Sage200Demo', 'width= 900, height= 768, status= 0, resizable= 0');return false;"><img src="images/icons/pdf-logo.png" width="30" height="30" alt="Adobe PDF icon"> 2014 Program</button>
                                </p>
                                <p class="d-grid gap-2">
                                    <button type="button" class="btn btn-outline-primary btn-sm" onclick="window.open('pdf/MBAR-2003-Program.pdf', 'Sage200Demo', 'width= 900, height= 768, status= 0, resizable= 0');return false;"><img src="images/icons/pdf-logo.png" width="30" height="30" alt="Adobe PDF icon"> 2003 Program</button>
                                </p>
                                <p class="d-grid gap-2">
