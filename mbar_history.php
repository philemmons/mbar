            ...
            <div class="col-lg-4 mb-3 mb-lg-0 px-4">
                <div class="card h-100 shadow-wrap">
                    <div class="card-body">
                        ...
                        <p class="card-text"> <a href="https://montereybayarearoundup.org/conference-2022.php" class="bb-link" target="_blank">2022 Conference<span class="sr-only">(Abre una nueva ventana)<span></a></p>
                        <p class="card-text"> <a href="https://montereybayarearoundup.org/conference-2019.php" class="bb-link" target="_blank">2019 Conference<span class="sr-only">(Abre una nueva ventana)<span></a></p>
                    </div>
