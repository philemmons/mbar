        ...
        <div class="row justify-content-center mb-5">
            ...
            <div class="col-xl-10 col-lg-10 col-md-12 py-4">
                <div class="p-3 text-bg-light hero-text-border" title="">
                    ...
                    <p class="mb-3 text-dark">If you wish to report an accessibility issue, have any questions or need assistance, please contact montereybayarearoundup.org </p>

                    <p class="mb-3 text-dark">Customer Support as follows - Email: <a href="mailto:systemadmin@mbar.philemmons.dev">SysAdmin with ADA request</a></p>
