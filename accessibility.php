        ...
        <div class="row justify-content-center mb-5">
            ...
            <div class="col-xl-10 col-lg-10 col-md-12 py-4">
                <div class="p-3 text-bg-light hero-text-border" title="">
                    ...
                    <p class="mb-6 h5 text-dark">montereybayarearoundup.org continues its efforts to constantly improve the accessibility of its site and services in the belief that it is our collective moral obligation to allow seamless, accessible and unhindered use also for those of us with disabilities.</p>

                    <p class="mb-6 h5 text-dark">Despite our efforts to make all pages and content on montereybayarearoundup.org fully accessible, some content may not have yet been fully adapted to the strictest accessibility standards. This may be a result of not having found or identified the most appropriate technological solution.</p>

                    <h4 class="fw-bold mb-3 text-primary">
                        <span class="text-dark px-3 px-md-0">Here For You</span>
                    </h4>

                    <p class="mb-6 h5 text-dark">If you are experiencing difficulty with any content on montereybayarearoundup.org or require assistance with any part of our site, please contact us during normal business hours as detailed below and we will be happy to assist.</p>
