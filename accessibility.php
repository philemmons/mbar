...
echo '<link rel="canonical" href= "https://montereybayarearoundup.org/accessibility.php" >';
        ...
        <div class="row justify-content-center py-6 mb-5 bg-body-tertiary bg-img-access" title="Accessibility workflow diagram with a laptop backdrop.">
            <div class="col-xl-7 col-lg-7 col-md-12 py-5">
                <div class="p-3 text-center text-bg-light hero-text-border" title="We care.">
                    <h2 class="display-6 fw-bold px-3 px-md-0">Accessibility Statement</h2>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="col-xl-10 col-lg-10 col-md-12 py-4">
                    <div class="p-3 text-bg-light hero-text-border" title="">
                        <section aria-label="accessibility method">
                            ...
                            <p class="mb-3 text-dark">If you are experiencing <strong>any difficulty or frustration</strong> with any content on montereybayarearoundup.org or require assistance with any part of our site, please contact us, and we will be happy to assist.</p>
