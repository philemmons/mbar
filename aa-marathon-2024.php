...
echo "<title>MBAR - A.A. Marathon Meetings 2024</title>";
        ...
        <div class="row justify-content-center py-6 mb-5 bg-body-tertiary bg-img-marathon-2024" title="Monterey Conference Center - Portola Plaza, Monterey.">
            <div class="col-xl-7 col-lg-7 col-md-12 py-5">
                <div class="p-3 text-center text-bg-light hero-text-border" title="2024 A.A. Marathon Meetings">
                    <h2 class="display-6 fw-bold px-3 px-md-0">2024 A.A. Marathon Meetings</h2>
                ...
                <div class="col-xl-10 col-lg-10 col-md-12 py-4">
                    <div class="p-3 text-center text-bg-light hero-text-border" title="Registration is Live">
                        <section aria-label="A.A. Marathon Schedule">
                            ...
                            <a class="bb-link" href="pdf/final-aa-marathon-meeting-2024.pdf"><img src="images/icons/pdf-logo.png" width="30" height="30" alt="Adobe PDF icon">A.A. Marathon Meeting Schedule<span class="sr-only">(Open pdf in browser)</span></a>
                        </section>
                    </div>
                </div>
            </div>
