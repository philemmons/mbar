...
echo "<br><title>MBAR - Privacy Policies and Terms </title>";
echo '<br><link rel="canonical" href= "https://monterey.bayarearoundup.org/privacy-policy.php" />';
                ...
                <div class="col-xl-10 col-lg-10 col-md-12 py-4">
                    <div class="p-3 text-bg-light hero-text-border" title="POLICIES">
                        <section aria-label="Use and policies">
                            ...
                            <br>
                            USERS of monterey.bayarearoundup.org can browse monterey.bayarearoundup.org without revealing USER'S personal information, but in order to take advantage of most of the services, USER must provide with personal information on forms. By providing personal information, USER expressly consents to the collection, use, disclosure and retention of USER'S personal information as described in this privacy policy ('PRIVACY POLICY'), and the terms set forth in our Terms &amp; Conditions. This PRIVACY POLICY covers MBAR and PROVIDER'S treatment of personal or personally identifiable information, herein referred to as 'PERSONAL INFORMATION', that may be collected when USER is on the MBAR and when USER uses MBAR services. This PRIVACY POLICY does not apply to the practices of companies or individuals that MBAR does not own or exercise supervisory control over, or to third party advertisers on the MBAR.
                            <br>
                            ...
                            <br><br>
                            <strong>THIS PRIVACY POLICY DISCLOSES THE PRIVACY PRACTICES FOR monterey.bayarearoundup.org. IT APPLIES SOLELY TO INFORMATION COLLECTED BY THIS WEBSITE. THIS PRIVACY POLICY WILL NOTIFY USER OF THE FOLLOWING:</strong>
                            <br>
                            ...
                            <br>
                            By submitting a telephone number to SITE, USER agree that a representative of monterey.bayarearoundup.org can contact USER at the number USER provide, potentially using automated technology (including texts/SMS messaging) or a pre-recorded message. Your consent is not an obligation to receive any of PROVIDER or FULFILLER's products and/or services.
                            <br>
