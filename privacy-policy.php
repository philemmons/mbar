...
<main>
    ...
    <section class="container shadow-wrap">
        <div class="row justify-content-center py-6 mb-5 bg-body-tertiary bg-img-privacy" title="">
            <div class="col-xl-7 col-lg-7 col-md-12 py-5">
                <div class="p-3 text-center text-bg-light hero-text-border" title="Preregistration is open!">
                    <h1 class="display-6 fw-bold mb-3 text-primary"><span class="text-dark px-3 px-md-0">Privacy Policy</span>
                    </h1>
                </div>
            </div>
        </div>
            ...
            <div class="col-xl-6 col-lg-6 col-md-12 pt-4">
                <div class="p-3 text-bg-light hero-text-border" title="">
                    ...
                    <p>EFFECTIVE DATE: <?php echo date("Y"); ?><br>
                        ...
                        Affiliated Sites.<br>
                        <br>
                        The Site contains links to other websites. We are not responsible for the privacy practices or the content of such websites. We have no control over such websites and you should exercise caution when deciding to disclose your Personal Information on other websites.<br>
                        <br>
                        Updates and Changes to Site Privacy Policy.<br>
                        <br>
                        We reserve the right, at any time and without notice, to add to, change, update, or modify this Site Privacy Policy, simply by posting such change, update, or modification on the Site and without any other notice to you. Any such change, update, or modification will be effective immediately upon posting on the Site.<br>
                        <br>
                        Contact Us<br>
                        <br>
                        For more information regarding this Site Privacy Policy or the Site, please <a href="contact.php">contact us</a> or at the address above:<br>
                    </p>
                </div>
                ...
                <div class="col-md-12 col-sm-12 col-xs-12 section-header">
                    ...
                    Policies<br><br>
                    General https://montereybayarearoundup.org/ ('SITE or MBAR ') acts as a marketplace, an intermediary between buyers and ticket sellers ('TICKET SELLERS') to facilitate the purchase and sale of event tickets, and as such is not directly involved in the actual ticket sale transaction between the buyers and TICKET SELLERS. All sales are final. As tickets sold through SITE are often obtained through the secondary market and prices are determined by the individual ticket seller, the prices for tickets may be above or below face value. Tickets sold through SITE are from a third party; therefore, the buyer's name will not be printed on the tickets. Please note that the name on the tickets does not affect the buyer's ability to access the event. By using or visiting this SITE or purchasing tickets in any manner from the SITE, you expressly agree to abide and be bound by these Terms and Policies, as well as all applicable laws, ordinances and regulations.<br>

                    <br>
                    ALL SALES ARE FINAL; there are no cancellations, returns, or exchanges.<br>
                    IF AN EVENT IS CANCELLED, you will be given a full refund minus any delivery charges if the tickets have already been delivered.<br>
                    IF AN EVENT IS POSTPONED OR RESCHEDULED, and the original tickets are valid for entry at the time of the rescheduled event, your order will not qualify for a refund.<br>
                    Confirmed orders may be filled with comparable or upgraded tickets if the original tickets are no longer available.<br>
                    All orders placed the SITE or with the customer contact center must be confirmed by the respective seller before the buyer guarantee takes effect.<br>
                    Our buyer guarantee provides for a full refund in the unlikely event that you do not receive valid tickets in time to attend the event.<br>
                    <br>
                    ...
                    All sales are final Since tickets are a one-of-a-kind item and not replaceable, there are no refunds, exchanges or cancellations. If an event is postponed or rescheduled, tickets will be honored for the rescheduled date. New tickets generally will not need to be issued; in the rare case that new tickets are needed, USER will be contacted by MBAR.<br>
                    <br>
                    If an event is cancelled without a rescheduled date, USER will need to contact the TICKET SELLER who fulfills USER's order (hereinafter known as 'FULFILLER') for a refund. The FULFILLER may require USER to return the supplied tickets at USER's expense before receiving any refund USER is entitled to due to cancellation. SITE is not responsible for providing or securing this refund for USER. Any shipping and handling charges are not refundable. Refunds will be processed in the same currency as the original order. Conversion charges, including though not exhaustive of the ones issued by USER's bank, if any, are not covered by SITE or Fulfiller. Neither SITE nor the FULFILLER will issue exchanges or refunds after a purchase has been made or for lost, stolen, damaged or destroyed tickets. When USER receives tickets, USER should keep them in a safe place. Please note that direct sunlight or heat may damage tickets.<br>
                    <br>
                    Ticket Availability SITE cannot and does not guarantee ticket availability until USER is in possession of their tickets. Generally, all ticket listings on SITE are a unique set of tickets from an individual TICKET SELLER. Some listings on SITE may only be representations of available tickets or an offer by SITE to obtain tickets and not actual seat locations or currently available tickets.<br>
                    <br>
                    Occasionally tickets ordered may no longer be available at the price or in the quantity originally ordered at the time the order is received. If equivalent or better seat locations are available at the same price, the TICKET SELLER will fill the order with the alternative seat locations. If no alternates are available, either USER'S credit card will not be charged at all or the entire amount will be refunded, and USER will be notified that the USER's request has been rejected.<br>
                    <br>
                    Orders placed through SITE will be fulfilled by one of SITE'S network of participating TICKET SELLERS. Contact information for the FULFILLER will be provided to USER upon completion of the purchase process. If this information is lost, USER may <a href="contact.html">contact customer support</a>
                    to retrieve information about the order. USER should carefully enter all required information when submitting an order. USER is responsible for any errors made when entering their information, errors may result in issues such as a delay in processing the order or in delivery of tickets or in cancellation of order.<br>
                    <br>

                    <b>Pricing</b><br>
                    All prices are in United States Dollars (USD) unless otherwise specifically stated. SITE cannot confirm the price for any products or services purchased on the SITE until after an order is completed by USER. Despite SITE'S best efforts, a small number of products and services listed on the SITE may be priced incorrectly. If the FULFILLER discovers the actual correct price is higher than the stated price, the FULFILLER will either complete the order at the original stated price, contact USER to inform them of different price with an option to purchase, or cancel USER'S order and notify USER of such cancellation.<br>
                    <br>
                    Schedule of Fees and Charges The price charged to USER's credit card beyond the price of the individual tickets shall include the following fees and charges:<br>
                    Service Fee: Cost per ticket associated with SITE operation, customer service center operation, obtaining tickets on behalf of USER and other costs associated with the fulfillment of USER's ticket request.<br>
                    Delivery: Costs associated with the Delivery Method chosen by USER and the SITE'S arrangement of USER's ticket delivery by the FULFILLER.<br>
                    Total: Entire amount charged to USER, including each ticket's price as set by the FULFILLER, Service Fee, and Delivery.<br>
                    <br>
                    Taxes <br>
                    ...
                    <br><br>
                    Fraudulent Use To protect USER from fraud, USER may be required to provide additional proof of identify on any order. Proof of identity may include but is not limited to a signed credit card authorization and/or photocopies of public documents such as a state driver's license or federal passport.<br>
                    <br>
                    ...
                    <br><br>
                    MBAR does update this PRIVACY POLICY from time to time so please review this PRIVACY POLICY regularly. If MBAR materially alters the PRIVACY POLICY, MBAR will notify you of such changes by posting a notice on MBAR and/or contacting you at the e-mail address provided to MBAR . Your continued use of the SITE will be deemed as your agreement that your information may be used in accordance with the new policy. If you do not agree with the changes, then you should stop using the SITE, and you should notify SITE that you do not want your information used in accordance with the changes.
                    <br><br>
                    This PRIVACY POLICY discloses the privacy practices for https://montereybayarearoundup.org/. It applies solely to information collected by this website. This PRIVACY POLICY will notify USER of the following:
                    <br><br>
                    ...
                    By submitting a telephone number to SITE, you agree that a representative of https://montereybayarearoundup.org/ can contact you at the number you provide, potentially using automated technology (icnluding texts/SMS messaging) or a pre-recorded message. Your consent is not an obligation to receive any of PROVIDER or FULFILLER's products and/or services.
                    <br><br>
                    ...
                    <br><br>
                    Opt out of any future contact from SITE or PROVIDER;<br>
                    See what data is on file about USER, if any;<br>
                    Change or correct any data on file about USER;<br>
                    Have deleted any data on file about USER; and<br>
                    Express any concern USER has about use of USER data.<br>
                    USER also has the option, at the time of purchase, to opt-in to receiving marketing material or third party offers.<br>
                    For more information regarding SITE's compliance with state-specific consumer privacy laws, please see below.<br>
                    <br><br>
                    ...
                    <br><br>
                    If USER feels that PROVIDER is not abiding by this PRIVACY POLICY, USER should contact SITE immediately via <a href="contact.html">contact customer support</a>
                    <br><br>
                    ...
                    <br><br>
                    The categories of PERSONAL INFORMATION collected about you;<br>
                    The categories of sources for the PERSONAL INFORMATION collected about you;<br>
                    The business or commercial purposes for collecting or selling that PERSONAL INFORMATION;<br>
                    The categories of third parties with whom PERSONAL INFORMATION has been shared with;<br>
                    The specific pieces of PERSONAL INFORMATION collected about you (also called a data portability request)<br>
                    ...
                    <br><br>
                    PROVIDER may deny your deletion request if retaining the information is necessary for PROVIDER or FULFILLER to:<br>
                    Complete the transaction for which the PERSONAL INFORMATION was collected, provide a good or service that you requeted, take actions reasonably anticipated within the context of the ongoing business relationship with you, or otherwise perform the contract between you and the TICKET SELLER.<br>
                    ...
                    Exercise free speech, protect the right of another consumer to exercise their free speech rights, or exercise another right provided for by law.<br>
                    ...
                    Make other itnernal and lawful uses of that information that are compatible with the context in which you provided it.<br>
                    Personal Information Sales Opt-Out Rights<br>
                    <br><br>
                    ...
                    <br><br>
                    To exercise the access, data portability, and deletion rights described above, please submit a verifiable consumer request to us:<br>

                    Only you, or your duly authorized representative, may make a verifiable consumer request related to your PERSONAL INFORMATION.v
                    <br>
                    ...
                    - Provide sufficient information that allows us to reasonably verify you are the person about whom PERSONAL INFORMATION was collected or an authorized representative<br>
                    - Describe your request with sufficient detail that allows PROVIDER to properly understand, evaluate, and respond to it.<br>
                    <br>
                    PROVIDER cannot respond to your request or provide you with PERSONAL INFORMATION if PROVIDER cannot verify your identity or authority to make the request and confirm that the PERSONAL INFORMATION relates to you. In your request, you need to provide enough information that allows PROVIDER to reasonably verify that you are the person that information was collected about.<br>
                    <br>
                    Making a verifiable consumer request does not require you create an account with us.<br>
                    <br>
                    PROVIDER will only use PERSONAL INFORMATION provided in a verifiable consumer request to verify the requestor's identity or authority to make the request.<br>
                    <br>
                    <br>
                    Response Timing and Format<br>
                    <br>
                    ...
                    <br>
                    Any disclosures PROVIDER provides will only cover the 12-month period preceding the verifiable consumer request’s receipt. The response PROVDER provides will also explain the reasons PROVIDER or FULFILLER cannot comply with a request, if applicable. For data portability requests, PROVIDER will select a format to provide your personal information that is readily useable and should allow you to transmit the information from one entity to another entity without hindrance.<br>
                    <br>
                    PROVIDER does not charge a fee to process or respond to your verifiable consumer request unless it is excessive, repetitive, or manifestly unfounded. If PROVIDER determines that the request warrants a fee, PROVIDER will tell you why PROVIDER made that decision and provide you with a cost estimate before completing your request. <br>
                    <br>
                    NON-DISCRIMINATION<br>
                    <br>

                    PROVIDER will not discriminate against you for exercising any of your CCPA rights. Unless permitted by the CCPA, PROVIDER will not:<br>
                    ...
                    - Provide you with a different level or quality of goods or services.<br>
                    ...
                    <br>
                    OTHER CALIFORNIA PRIVACY RIGHTS<br>
                    <br>
                    California Civil Code Section § 1798.83, the “Shine the Light” law, permits users of our Site that are California residents to request certain information regarding our disclosure of personal information to third parties for their direct marketing purposes. To make such a request, please send an email to <a href="contact.html">contact customer support</a>
                    <br><br>
                    Copyright Infringement Notification Should USER wish to file a copyright infringement notification with SITE, USER will need to send a written or electronic communication that includes all of the following, as based on Section 512(c)(3) of the Digital Millennium Copyright Act (DMCA):<br>
                    <br>
                    Identification of the material that is claimed to be infringing or to be the subject of infringing activity. *Please provide the URL(s) in the body of the email or letter, as this will help us to identify the potentially infringing material.<br>
                    Contact information of the complainant.<br>
                    ...
                    <br>
                    Copyright Complaints <a href="contact.html">contact customer support</a>
                    <br>
                    ...
                    <br><br>
                    IF AN EVENT IS CANCELLED AS A RESULT OF COVID-19, you may have an option to receive a credit voucher ('Credit Voucher') in the amount of 110% of the original purchase price (minus any delivery charges) (the 'Value') to be used towards any ticket purchase made on SITE within 365 days from your Credit Voucher issuance date. Alternatively, you may request a full refund (minus any delivery charges).<br>
                    Credit Vouchers can be used for separate purchases as long as any portion of the Credit Voucher retains its Value; however, this will not extend Your Credit Voucher's valid through date.<br>
                    ...
                    Your Credit Voucher cannot be transferred to another individual or used as a payment method on any other site, other than the site where your original purchase was made, and it cannot be transferred to a different currency. If the Site where your original purchase was made is no longer in service, Your Credit Voucher will still be honored.<br>
                    If You choose not to utilize the Credit Voucher program, please be advised that due to recent events, your refund may take up to 30 days to be processed.<br>
                    By accepting the offer of a Credit Voucher or Refund, you agree that no further payment shall be made to you with respect to the purchase in question and you agree not to seek any additional refunds, credits or chargebacks. You understand that your Credit Voucher or Refund is the sole remedy available to you for your original purchase. If a chargeback is filed against the merchant of record with your credit card company, we reserve the right to withdraw any offers made, including this Credit Voucher offer.<br>
                    If you take no action after receiving a notification from us, you will receive a voucher by default. If you have received a voucher, but prefer to receive a cash refund, then you must contact our customer service within seven (7) calendar days from receiving the cancellation notification.<br>
                    ...
                    NO SPECTATORS EVENTS. If your event is announced to be played without spectators as a result of COVID-19, it will be treated as if the event is cancelled. These tickets will be eligible for a refund or Credit Voucher program unless event organizers inform us otherwise.<br>
                    All other Terms and Conditions remain in full force and effect without amendment or modification.<br>
                    ...
                    On behalf of yourself and your Related Persons, you further hereby release (and covenant not to sue) each of the Released Parties with respect to any and all claims that you or any of your Related Persons may have (or hereafter accrue) against any of the Released Parties and that relate in any way to (i) your exposure to COVID-19; (ii) your entry into, or presence within or around, the Event (including all risks related thereto, and including without limitation in parking areas or entry gates) or compliance with any protocols applicable to the Event; or (iii) any interaction between you and any personnel of any of the Released Parties present at the Event, in each case whether caused by any action, inaction or negligence of any Released Party or otherwise.<br><br>


                    3. SEVERABILITY CLAUSE<br><br>
                    ...
                    These policies were last amended 2022.
