        ...
        <div class="row justify-content-center mb-5">
            ...
            <div class="col-xl-10 col-lg-10 col-md-12 pt-4">
                <div class="p-3 text-bg-light hero-text-border" title="">
                    ...
                    <br>
                    If SITE receives the email with written proof from the venue and USER's description of the circumstances of the denied entry within ten (10) days of the event, SITE will investigate USER's claim. If SITE, in its reasonable discretion, determines that USER was denied entry USER will receive a refund of the cost of the tickets and all fees and shipping charges. The refund will be USER's sole remedy for the denied entry.<br>
                    <br>
                    ...
                    Information Collection, Use, and Sharing PROVIDER and FULFILLER are the sole users of the information collected on this SITE. PROVIDER only has access to or collects information that USER voluntarily gives via email or other direct contact from USER or if USER gives SITE permission to access such information, such as requesting or purchasing tickets from a FULFILLER, including, but not limited to, name, address, email address, telephone number, credit/debit card information and purchase information.
                    <br><br>
