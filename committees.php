            ...
            <article>
                <div class="col-xl-8 col-lg-8 col-md-10 pt-4">
                    <div class="p-3 text-center text-bg-light hero-text-border">
                        <section>
                            <h3 class="fw-bold"><span class="text-dark px-3 px-md-0">Past and Present Planning Committee's</span>
                            </h3>
                        </section>
                    </div>
                </div>
                ...
                <div class="col-xl-11 col-lg-9 col-md-7 py-4">
                    <table class="table table-bordered" id="planning-committee-2024" summary="The planning committee contains three parts, and they are A.A. Steering Committee, Al-Anon Steering Committee, and A.A. Committee Chairs.">
