    ...
    <section class="container shadow-wrap">
        <div class="row justify-content-center">
            <div class="col-xl-10 col-lg-12 col-md-12 pt-4">
                ...
                <a href="registration.php" class="btn btn-light btn-lg active" role="button" aria-pressed="true"><img src="../images/button-reg.png" alt="2022 logo with register here text."></a>
                </div>
            </div>
        </div>
