...
echo '<link rel="canonical" href= "https://montereybayarearoundup.org/conference-2022.php" >';
            ...
            <ul class="navbar-nav mx-auto mt-2 mt-lg-0">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdown-conference">
                        ...
                        <a class="dropdown-item active" aria-current="page" href="mbar_history.php">MBAR History<span class="visually-hidden">(2022 conference, click to go back)</span></a>
        ...
        <div class="row justify-content-center py-6 mb-5 bg-body-tertiary bg-img-conference-2024" title="MBAR Conference 2022 Archive">
            <div class="col-xl-7 col-lg-7 col-md-12 py-5">
                <div class="p-3 text-center text-bg-light hero-text-border" title="Registration is Live!">
                    <h2 class="display-6 fw-bold text-primary"><span class="text-dark px-3 px-md-0">Monterey Bay Area Round Up 2022 Archive</span></h2>
                </div>
            </div>
        </div>
    </div>
