            ...
            <ul class="navbar-nav mx-auto mt-2 mt-lg-0">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdown-conference">
                        ...
                        <a class="dropdown-item active" aria-current="page" href="aa-spanish-marathon-2024.php">Spanish A.A. Marathon Meetings<span class="visually-hidden">(current)</span></a>
                    ...
                    <div class="p-3 text-center text-bg-light hero-text-border">
                        ...
                        <section aria-label="Saturday's Spanish A.A. Meetings">
                            ...
                            <div class="row g-0 mb-4">
                                ...
                                <div class="col-sm-6 bottom marathon-cell">
                                    Topic: Move Away From the First Drink
                                </div>
                        ...
                        <section aria-label="Sunday's A.A. Meetings">
                            ...
                            <div class="row g-0 mb-4">
                                ...
                                <div class="col-sm-6 bottom marathon-cell">
                                    Topic: Participation and Action
                                </div>
                                ...
                                <div class="col-sm-6 bottom marathon-cell">
                                    Topic: Belief in a Higher Power
                                </div>
