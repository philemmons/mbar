        ...
        <div class="row justify-content-center mb-5">
            <div class="col-xl-10 col-lg-10 col-md-12 pt-4">
                <div class="p-3 text-center text-bg-light hero-text-border" title="Memories are in the making.">
                    <h4 class="fw-bold mb-3 text-primary"><span class="text-dark px-3 px-md-0">Please contact us with any questions, feedback, or improvements because we care. We really do.</span>
                    </h4>
                </div>
            </div>
        ...
        <div class="row justify-content-center mb-5">
            <div class="col-xl-8 col-lg-8 col-md-10 py-4">
                <div class="p-3 text-center text-bg-light hero-text-border">
                    <p class="mb-6 h4 text-dark">Please allow us up to 48 hours to respond, and if you need assistance sooner, please email <? echo getenv('mbar-chair-email'); ?> </p>
                </div>
            </div>
        </div>
    </section>
